...
<h3>Registrarse</h3> </form>
	...
	<form action="guardar.php" id="form-session" method="post">
...
<input type="email" class="form-control" name="correo" placeholder="Escriba un correo electrónico">
