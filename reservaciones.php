      ...
      <section class="section testi text-center has-bg-image"
        ...
        <div class="container">
          ...
          <p class="headline-2 testi-text">
            Nuestro chef principal es un artista culinario apasionado, 
            cuya dedicación a la excelencia se refleja en cada plato que sale de nuestra cocina.
          </p>
          ...
          <div class="profile">
            ...
            <p class="label-2 profile-name">Chef</p>
          </div>
...
<h3>Reservaciones</h3> </form>
	...
	<form action="guardareser.php" id="form-session" method="post">
...
<input type="text" class="form-control" name="nombre" placeholder="Escriba un nombre de Usuario">
...
<input type="text" class="form-control" name="telefono" placeholder="Escriba un numero de telefono">
</div>
...
<input type="text" class="form-control" name="personas" placeholder="Escriba un numero de personas">
...
<input type="text" class="form-control" name="fecha" placeholder="formato fecha YY/MM/DD">
...
<input type="text" class="form-control" name="hora" placeholder="Horarios: 8:00am a 10:00pm">
